...
<div class=" bloc1">
  <form action="{{route('ajoutSite')}}" style="margin-top:20px" method="post" enctype="multipart/form-data">
      @csrf
    <!-- <img class="" src="{{ asset('assets/brand/logo_rire.jpg') }}" alt="" width="150" height="100" style="margin-bottom:-35px"> -->
    <h1 class="h3 mb-5 fw-normal"><strong>Nouveau site</strong></h1>
    ...
    <div class="form-floating">
      ...
      <label for="name">Description du site</label>
      @error('description')
      <div class="invalid-feedback">
      {{ $message }}
      </div>
    ...
    <div class="form-floating">
      <input type="number" class="form-control @error('name') is-invalid @enderror" value="{{ old('localisation') }}" id="localisation" name="localisation" placeholder="prix"  style="border-radius:20px">
    ...
    <div class="form-floating">
       <select class="form-control @error('category_id') is-invalid @enderror" id="category_id" name="category_id" style="border-radius: 20px">
